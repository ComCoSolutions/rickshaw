		...
		<div id="list-order" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="total" title="${message(code: 'order.total.label', default: 'Total')}" />
				...
				<g:each in="${orderInstanceList}" status="i" var="orderInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${orderInstance.id}">${fieldValue(bean: orderInstance, field: "total")}</g:link></td>
