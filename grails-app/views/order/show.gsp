	...
	<body>
		...
		<div id="show-order" class="content scaffold-show" role="main">
			...
			<ol class="property-list order">
				...
				<g:if test="${orderInstance?.total}">
				<li class="fieldcontain">
					<span id="total-label" class="property-label"><g:message code="order.total.label" default="Total" /></span>
					
						<span class="property-value" aria-labelledby="total-label"><g:fieldValue bean="${orderInstance}" field="total"/></span>
				...
				<li class="fieldcontain">
					<span id="orderItems-label" class="property-label"><g:message code="order.orderItems.label" default="Order Items" /></span>
					
						<g:each in="${orderInstance.orderItems}" var="o">
						<span class="property-value" aria-labelledby="orderItems-label"><g:link controller="orderItem" action="show" id="${o.id}">${o?.encodeAsHTML()}</g:link></span>
						</g:each>
